...
export class UpdiDatalink16bit extends UpdiDatalink {
   ...
   * @return value read
   */
  override async ld(address: number): Promise<number> {
    if (!this.updiPhy) throw new Error("Physical layer not initialized");
    await this.updiPhy.send(new Uint8Array([
      constants.UPDI_PHY_SYNC,
   ...
   * @return values read
   */
  override async ld16(address: number): Promise<Uint8Array> {
    if (!this.updiPhy) throw new Error("Physical layer not initialized");
    await this.updiPhy.send(new Uint8Array([
      constants.UPDI_PHY_SYNC,
   ...
   * @param value value to write
   */
  override async st(address: number, value: number): Promise<void> {
    if (!this.updiPhy) throw new Error("Physical layer not initialized");
    await this.updiPhy.send(new Uint8Array([
      constants.UPDI_PHY_SYNC,
   ...
   * @param value value to write
   */
  override async st16(address: number, value: number): Promise<void> {
    if (!this.updiPhy) throw new Error("Physical layer not initialized");
    await this.updiPhy.send(new Uint8Array([
      constants.UPDI_PHY_SYNC,
   ...
   * @param address address to write
   */
  override async stPtr(address: number): Promise<void> {
    if (!this.updiPhy) throw new Error("Physical layer not initialized");
    await this.updiPhy.send(new Uint8Array([
      constants.UPDI_PHY_SYNC,
